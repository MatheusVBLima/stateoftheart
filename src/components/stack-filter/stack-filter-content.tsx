...
export function StackFilterContent() {
  ...
  const { data: implementationDetails, isLoading: isLoadingDetails } = useQuery(
    {
      ...
      queryFn: async () => {
        const response = await fetch(
          `/api/implementation/${selectedImplementation}`,
        );
        if (!response.ok) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div
        className={`${
          selectedImplementation ? "grid grid-cols-1 lg:grid-cols-2 gap-8" : ""
        }`}
      >
        {/* Main Content */}
          ...
          <header className="mb-12">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Select the technologies in your stack and discover which ones
                are currently
          ...
          <div className="max-w-4xl mx-auto mb-12">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Choose the technologies you use or are interested in. Only
                  State of the Art technologies are shown.
                </CardDescription>
              </CardHeader>
                                  ...
                                  <div className="flex items-center space-x-1">
                                    ...
                                    >
                                      <path
                                        ...
                                        strokeWidth="2"
                                        d="M14 10h4.764a2 2 0 011.789 2.894l-3.5 7A2 2 0 0115.263 21h-4.017c-.163 0-.326-.02-.485-.60L7 20m7-10V18m-7-8a2 2 0 01-2-2V7a2 2 0 012-2s0 0 0 0 1.98 0 2 0h1m2 0h3m2 0a2 2 0 012 2v3a2 2 0 01-2 2H9m12 0a2 2 0 01-2 2v0c0 1.1-.9 2-2 2H9m3 0h3"
                                      />
                                    </svg>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground max-w-md mx-auto">
                    Choose technologies from the selector above to see which
                    ones are currently State of the Art in the community.
                  </p>
                </div>
        ...
        {selectedImplementation && (
          <div className="lg:sticky lg:top-20 lg:h-[calc(100vh-6rem)]">
            <AccentCard className="h-full">
              <AccentCardHeader>
                <AccentCardHeading>
                  <AccentCardTitle className="text-lg text-foreground">
              ...
              <AccentCardContent className="p-0 pt-2">
                    ...
                    <div className="space-y-6 pb-6">
                      ...
                      <div className="space-y-3">
                        <div className="flex items-start justify-between gap-3">
                          ...
                          <div className="flex gap-2 shrink-0">
                            <Button
                              ...
                              size="sm"
                              onClick={() => {
                                // TODO: Implement copy to LLM functionality
                              }}
                            >
                            ...
                            <Button
                              ...
                              onClick={() =>
                                window.open(
                                  `/implementation/${implementationDetails.slug}`,
                                  "_blank",
                                )
                              }
                            >
                        ...
                        <p className="text-muted-foreground">
                          {implementationDetails.description}
                        </p>
                      </div>

                      {/* Content */}
                      {implementationDetails.content && (
                        <div>
                      ...
                      <div>
                        ...
                        <Badge variant="outline">
                          {implementationDetails.category.name}
                        </Badge>
                      </div>
                      ...
                      {/* Comments Preview */}
                      {implementationDetails.comments &&
                        implementationDetails.comments.length > 0 && (
                          <div>
                            <h3 className="font-semibold mb-3 text-foreground">
                              Latest Comments
                            </h3>
                            <div className="space-y-3">
                              ...
                              {implementationDetails.comments.length > 3 && (
                                ...
                                >
                                  View all{" "}
                                  {implementationDetails.comments.length}{" "}
                                  comments
                                </Button>
                              )}
                            </div>
